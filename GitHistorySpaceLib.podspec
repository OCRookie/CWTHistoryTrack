...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of GitHistorySpaceLib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/isoftstone/GitHistorySpaceLib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'isoftstone' => '921468573@qq.com' }
  s.source           = { :git => 'https://github.com/isoftstone/GitHistorySpaceLib.git', :tag => s.version.to_s }
